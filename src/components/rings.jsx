...
// может быть их в цикле рендерить? В цикле получаю данные с таблицы и отрисовываю каждый круг с полученными в цикле данными. Иначе я не знаю, как передать в каждый круг свои данные, если только не создавать массив из данных и через a[a.length - 1] получать их
